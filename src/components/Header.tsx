...
export function Header() {
  return (
    <header className='sticky top-4 z-50 mt-4 mb-6 flex w-full px-[16px]'>
      <nav className='xs:flex-row bg-background-secondary border-border-secondary xs:w-fit xs:rounded-full bg-card/80 border-border xs:py-3 mx-auto inline-flex w-full flex-col items-center justify-center gap-3 rounded-4xl border px-6 py-4 shadow-md backdrop-blur-lg backdrop-blur-sm'>
